...
class Test(unittest.TestCase):
    def test_datetime_to_filetime(self) -> None:
        test_datetimes = [
            ...
            (datetime.datetime(2025, 3, 30, 0, 30, tzinfo=zoneinfo.ZoneInfo("Europe/London")), 133877682000000000), # before daylight savings
            (datetime.datetime(2025, 3, 30, 1, 30, tzinfo=zoneinfo.ZoneInfo("Europe/London")), 133877718000000000), # ambiguous transition
            (datetime.datetime(2025, 10, 26, 1, 30, tzinfo=zoneinfo.ZoneInfo("Europe/London")),134059122000000000),  # repeated hour
            ...
            (datetime.datetime(2025, 6, 1, 12, 0, tzinfo=zoneinfo.ZoneInfo("America/New_York")), 133932672000000000), # US Eastern
            (datetime.datetime(2025, 6, 1, 12, 0, tzinfo=zoneinfo.ZoneInfo("Asia/Tokyo")), 133932204000000000),  # Japan time
        ...
        for datetime_in, expected_filetime in test_datetimes:
            with self.subTest(f"Datetime to filetime {datetime_in} expects {expected_filetime}"):
